...
function FirstBloodScene:ctor( )
	...
	local map = cc.TMXTiledMap:create("res/Maps/Test/Test1.tmx")
	layer:addChild(map)
	self:addChild(layer)
end
...
-- function FirstBloodScene:ctor( )
-- 	local layer = cc.Layer:create()
-- 	local spr = cc.Sprite:create('cocosstudio/Atlases/Levels/FirstBlood/Furniture/sprElisChairWood001.png')
